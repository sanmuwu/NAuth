			...
			<tbody>
				<c:forEach items="${list}" var="menu">
					<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
						...
						<%-- <td nowrap>
							<div title="${menu.menuCode}" class="text-ellipsis span2" style="margin-left: 0px;">
								${menu.menuCode}
							</div>	
						</td> --%>
						<td>
							<div title="${menu.href}" class="text-ellipsis span3" style="margin-left: 0px;">
								${menu.href}
							</div>	
						</td>
						<td style="text-align:center;">
							<div class="text-ellipsis span1" style="margin-left: 0px;">
						...
						<td>
							<div title="${menu.permission}" class="text-ellipsis span5" style="margin-left: 0px;">
								${menu.permission}
							</div>
						</td>
						<td nowrap>
