...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					name: {remote: "${ctx}/sys/office/checkOrgName?oldName=" + encodeURIComponent('${office.name}')},
				},
				messages: {
					name: {remote: "机构名称已存在"},
				},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list?id=&parentIds=">机构列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">“是”代表此机构可以使用，“否”则表示此机构不可以使用</span>
			</div>
		</div>
		<%-- <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				 <input id="officeCreateDate" name="officeCreateDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="${office.officeCreateDate}"
					onclick="WdatePicker({dateFmt:'yyyyMMdd',maxDate:'#F{$dp.$D(\'officeBusinessDate\')}',isShowClear:false});"/>
					 <span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<input id="officeBusinessDate" name="officeBusinessDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="${office.officeBusinessDate}"
					onclick="WdatePicker({dateFmt:'yyyyMMdd',minDate:'#F{$dp.$D(\'officeCreateDate\')}',isShowClear:false});"/>
					<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div> --%>
