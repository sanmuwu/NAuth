	...
	<div id="main">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${(menu.parent.id eq '1'&&menu.isShow eq '1') || ((fns:getUser() eq '1') && (menu.id eq 'd744c03487344cbe842d7d08c6d6aa3e') )}">
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				...
				<div id="right">
					<iframe id="mainFrame" name="mainFrame" src="${ctx}/loginWelcome" style="overflow:visible;" scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="###" target="_blank">夸客金融</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
