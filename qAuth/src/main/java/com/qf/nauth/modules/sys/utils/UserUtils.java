 ...
 */
package com.qf.nauth.modules.sys.utils;
...
public class UserUtils {
	...
	//private static SysAuthDao sysAuthDao = SpringContextHolder.getBean(SysAuthDao.class);
	...
	public static final String USER_CACHE_USERNAME_ = "userame_";
	...
	public static User getUser(String username) {
		...
		if (user == null) {
			...
			if(user != null) {
				CacheUtils.put(USER_CACHE, USER_CACHE_USERNAME_ + username, user);
...
//			}
	 ...
	 * @return
	 */
	public static List<Role> getRoleListUseable() {
		Role role = new Role();
