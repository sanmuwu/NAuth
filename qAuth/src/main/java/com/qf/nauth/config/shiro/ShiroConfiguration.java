...
import com.qf.nauth.common.security.shiro.session.CacheSessionDAO;
import com.qf.nauth.common.utils.IdGen;
import com.qf.nauth.config.springbean.ContextProperties;
import com.qf.nauth.modules.auth.constant.Adconfigs;
import com.qf.nauth.modules.sys.security.credentials.OAuthCredentialsMatcher;
import com.qf.nauth.modules.sys.security.filters.AuthcAuthenticationFilter;
import com.qf.nauth.modules.sys.security.realms.LdapAuthenticationRealm;
import com.qf.nauth.modules.sys.security.realms.LdapAuthorizingRealm;
import com.qf.nauth.modules.sys.security.realms.SystemDbAuthenticationRealm;
import com.qf.nauth.modules.sys.security.session.SessionManager;
import com.qf.nauth.modules.sys.security.shiro.ModularRealmAuthenticator;
...
@EnableConfigurationProperties(value = {ShiroConfigProperties.class, ContextProperties.class,Adconfigs.class})
...
//	}
	...
	// ldap认证处理器
	@Bean(name = "ldapAuthorizingRealm")
	public LdapAuthorizingRealm ldapAuthorizingRealm1() {
		LdapAuthorizingRealm ldapAuthorizingRealm  = new LdapAuthorizingRealm();
		JndiLdapContextFactory jndi = new JndiLdapContextFactory();
		jndi.setUrl(adconfigs.getUrl()/*"ldap://wh-dc-02.quark.com:389/"*/);
		ldapAuthorizingRealm.setContextFactory(jndi);
		return ldapAuthorizingRealm;
	}
	...
	public DefaultWebSecurityManager securityManager() {
		...
		realms.add(ldapAuthorizingRealm1()); 					// 添加ldap认证处理器
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean() {
		...
		filterChainDefinitionMap.put(contextProperties.getAdminPath() + contextProperties.getUserAndRoleUrl(), "anon");
		filterChainDefinitionMap.put(contextProperties.getAdminPath() + contextProperties.getMenuListUrl(), "anon");
